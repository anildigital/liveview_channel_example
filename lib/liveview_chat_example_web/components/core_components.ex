defmodule LiveviewChatExampleWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(LiveviewChatExampleWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(LiveviewChatExampleWeb.Gettext, "errors", msg, opts)
    end
  end
